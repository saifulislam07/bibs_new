...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-success waves-effect pull-right" onclick="unapprovePost({{ $member->id }})">
        <i class="material-icons">done</i>
        <span>Disable Member</span>
    </button>
    <form method="post" action="{{ route('admin.member.disable',$member->id) }}" id="approval-form" style="display: none">
        @csrf
        @method('PUT')
    </form>
    @else
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                   <img class="img-responsive thumbnail" src="/public/upload/profile/{{ $member->image }}">
...
<script>
    ...
    // unapporove post
        ...
        swal({
            title: 'Are you sure?',
            text: "You went to disable member ",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
