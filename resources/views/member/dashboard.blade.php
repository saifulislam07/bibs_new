           ...
           <div class="col-lg-12 bg-blue-grey col-md-3 col-sm-6 col-xs-12">
                <div class="">
                    ...
                    <div>
                        ...
                        <marquee><h2>@foreach($notices as $key=>$notice){{$notice->discription}}{{"--"}}
                            @endforeach
                            </h2></marquee>
            ...
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-pink hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $getPay }}" data-speed="15" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Notices</div>
                        <div class="number count-to" data-from="0" data-to="{{$notice_count}}" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-green hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">Payment Policies</div>
